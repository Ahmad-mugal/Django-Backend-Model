...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super().save(*args, **kwargs)  # Save the instance to ensure it gets an 'id'
        if creating and self.created_date:
            self.unique_id = self.created_date.strftime('75%Y%m%d23') + str(self.id)
            super().save(update_fields=['unique_id'])  # Save again with the unique_id
